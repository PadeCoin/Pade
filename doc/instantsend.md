...
This mechanism has been integrated into Bitcore-Node-Pade which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/pade/insight-api-pade#web-socket-api](https://github.com/pade/insight-api-pade#web-socket-api)
* API: [https://github.com/pade/insight-api-pade#instantsend-transactions](https://github.com/pade/insight-api-pade#instantsend-transactions)
...
By default, the Pade Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Pade Core daemon:
