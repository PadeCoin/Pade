...
Only requiring some minor changes is pade.cpp.
...
Changes to pade.cpp
----------------------
pade.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
