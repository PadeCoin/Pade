    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Pade Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Pade address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pade: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Pade Core"), this);
    aboutAction->setStatusTip(tr("Show information about Pade Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Pade Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Pade addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Pade addresses"));
    ...
    openAction->setStatusTip(tr("Open a pade: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Pade Core help message to get a list with possible Pade Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Pade Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Pade network", "", count));
}
...
{
    QString strTitle = tr("Pade Core"); // default title
