    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("PAD-light"), QVariant("light"));
    ui->theme->addItem(QString("PAD-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("PAD-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("PAD-traditional"), QVariant("trad"));
