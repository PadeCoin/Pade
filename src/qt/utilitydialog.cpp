    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Pade Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Pade Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  pade-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Pade in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 PAD, 0.1 PAD, 1 PAD and 10 PAD -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://www.pade.com\">www.pade.com</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Pade Core is shutting down...") + "<br /><br />" +
