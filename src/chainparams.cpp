...
{
    const char* pszTimestamp = "Main Street’s Gain May Be Wall Street’s Pain";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 60 * 60; // Pade: 1 hour, 24 blocks
        consensus.nPowTargetSpacing = 2.5 * 60; // Pade: 150 seconds
        ...
        genesis = CreateGenesisBlock(1524553116, 2288784, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000416011a6c0336d04ad93e5beace503263ffdd346d6e72868886ff4b848c"));
        assert(genesis.hashMerkleRoot == uint256S("0x4d760985afec9060028fb9ebb36ec8616d91f35d50df6e454acbb9fa8a97abfe"));

        vSeeds.push_back(CDNSSeedData("padecoin.io", "seed1.padecoin.io"));

        // Pade addresses start with 'P'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,55);
        // Pade script addresses start with '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,21);
        // Pade private keys start with 'J' (?)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,43);
        // Pade BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Pade BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // Pade BIP44 coin type is '5'
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
                (    0, uint256S("0x00000416011a6c0336d04ad93e5beace503263ffdd346d6e72868886ff4b848c"))
				(    1, uint256S("0x0000000c7892e3fa027fe041a012a98c9e6b4dade7c24fecf02664c1124ab19d"))
				(  105, uint256S("0x0000067e2bf776024423b6b0c52edd9c87003cd10f21c2f195504344d476c4dc")),
                1524631440, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("padecoin.io", "test-seed1.pade.io"));

        // Testnet Pade addresses start with 'T'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Testnet Pade script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,15);
        // Testnet private keys start with 'W' (Bitcoin defaults) (?)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,73);
        // Testnet Pade BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Pade BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet Pade BIP44 coin type is '1' (All coin's testnet default)
        ...
        checkpointData = (CCheckpointData) {
            ...
            1524553116, // * UNIX timestamp of last checkpoint block
...
public:
    CRegTestParams() {
        ...
        // Regtest Pade addresses start with 'T'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Regtest Pade script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,15);
        // Regtest private keys start with 'W' (Bitcoin defaults) (?)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,73);
        // Regtest Pade BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Pade BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Regtest Pade BIP44 coin type is '1' (All coin's testnet default)
        base58Prefixes[EXT_COIN_TYPE]  = boost::assign::list_of(0x80)(0x00)(0x00)(0x01).convert_to_container<std::vector<unsigned char> >();
   }
};
