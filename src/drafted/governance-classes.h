 ...
 *
 *   // network
 *   CPadeNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CPadeNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: PadeNetwork
// //   -- signature requirements : Key1(User)
// class CPadeNetworkVariable : public CGovernanceObject
// {
// private:
