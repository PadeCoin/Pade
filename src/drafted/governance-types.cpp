...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "PadeNetwork") type = PadeNetwork;
    if(strType == "PadeNetworkVariable") type = PadeNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == PadeNetwork) s = "PadeNetwork";
    if(type == PadeNetworkVariable) s = "PadeNetworkVariable";
